...
data_root = "data/KeyboneNetCross"
category = 'fbh'
ignore_index = -1
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="PCATransform", n_components=3),
            dict(type='RandomFlip', p=0.5),
            dict(type='RandomRotate', axis="x", angle=[-1/2, 1/2]),
...
hooks = [
    ...
    dict(type="CorrespondenceEvaluator", pck_alpha=0.3),
